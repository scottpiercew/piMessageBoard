...
<div class="flex flex-col space-y-8 content-between">
  <div class="rounded-sm shadow-md bg-black">
    <div class="py-2 bg-gray-800 text-warmGray-200 text-center text-lg flex justify-start content-center shadow-md">
      <div class="flex">
  ...
  <div class="rounded-sm shadow-md bg-black">
    ...
    <div class="relative bg-black text-warmGray-100 p-4">
      ...
      <div class="pt-4 text-lg">- {schedule.events[2]}</div>
      <div class="pt-4 text-lg">- {schedule.events[3]}</div>
    </div>
  </div>
  <div class="rounded-sm shadow-md bg-black">
    <div class="py-2 bg-gray-800 text-warmGray-200 text-center text-lg flex justify-start content-center shadow-md">
    ...
    <div class="relative bg-black text-warmGray-100 p-4">
      <div class="absolute inset-0 opacity-10 bg-white z-50"></div>
      <img src={schedule.daySchedule} alt={schedule.daySchedule} class="w-full p-4 filter-invert max-h-2/3 object-contain" />
    </div>
  </div>
</div>